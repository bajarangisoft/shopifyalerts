...
<head>
    ...
    <link href="https://tailwindcss.com/_next/static/css/1bea9f675daa1c112700.css" rel="stylesheet"/>
    <link href="//cdn.shopify.com/s/files/1/0523/5667/7813/t/1/assets/components-v2.css?v=10468021920627273783" rel="stylesheet"/>
    <style>
        .shadow {
    ...
    <script src="//cdn.shopify.com/s/files/1/0523/5667/7813/t/1/assets/jquery.timepicker.min.js?v=3186370423840310595"></script>
    <link href="//cdn.shopify.com/s/files/1/0523/5667/7813/t/1/assets/jquery.timepicker.css?v=6397861991743500590" rel="stylesheet"/>
    <script src="https://cdn.jsdelivr.net/gh/alpinejs/alpine@v2.3.5/dist/alpine.js" defer=""></script>
    <script src="//cdn.shopify.com/s/files/1/0523/5667/7813/t/1/assets/jquery.ddslick.min.js?v=12400394491797829032"></script>
    {{--    <script src="//cdn.shopify.com/s/files/1/0523/5667/7813/t/1/assets/custom.js?v=3908779952087670320"></script>--}}
    <script src="{{asset('js/custom-jquery-1.js')}}"></script>
    ...
    <script>
        // var condition_count = 0; var filter_count = 0; var action_count = 0;
        window.Components = {
...
<body class="antialiased font-sans bg-gray-50" data-new-gr-c-s-check-loaded="14.988.0" data-gr-ext-installed="">
<div class="" style="">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="flex-shrink-0 flex items-center">
                                <img class="hidden lg:block h-8 w-auto" src="//cdn.shopify.com/s/files/1/0523/5667/7813/t/1/assets/storealerts-logo.png?v=6262945284535608954" alt="Workflow">
                            </div>
                        ...
                        <div class="flex items-center">
                            <div class="flex-shrink-0">
                                <button type="button" class="relative inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md text-white bg-indigo-600 shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                    <svg class="-ml-1 mr-2 h-5 w-5" x-description="Heroicon name: plus" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            ...
            <div class="w-full flex max-w-7xl mx-auto xl:px-0 lg:flex xl:border-l xl:border-r xl:border-gray-400 xl:border-opacity-40">
                ...
                <form action="{{url('post_data')}}" method="post">
                    ...
                    <div class="md:grid md:grid-cols-1 md:gap-6 w-full pt-6 pb-6">
                        ...
                        <div class="md:col-span-1 w-full mt-2 p-6 max-w-7xl mx-auto px-6 xl:border-t xl:border-gray-400 xl:border-opacity-20">
                            ...
                            <div class="condition-block-location">
                                <div class="condition-block-wrap" data-condition-block="1">
                    ...
                    <div style="visibility: hidden" class="selector-stash" data-selectclasses=" inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="order" name="order" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="customer" name="customer" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="address_type" name="address_type" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="discounts" name="discounts" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="shipping" name="shipping" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="shipping_lines" name="shipping_lines" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="line_items" name="line_items" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <!-- general logics -->
                        <select id="country_code" name="country_code" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="currency_logic" name="currency_logic" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="country" name="country" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="money_set_logic" name="money_set_logic" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="money_logic" name="money_logic" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="text_logic" name="text_logic" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="is_isnot_logic" name="is_isnot_logic" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="is" data-select="textbox">is</option>
                            <option value="is_not" data-select="textbox">is not</option>
                            <option value="is_empty" noswap>is not empty</option>
                            <option value="is_not_empty"noswap>is empty</option>
                        </select>
                        <select id="number_logic" name="number_logic" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="number_logic_extended" name="number_logic_extended" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="more_than" data-select="textbox">more than</option>
                            <option value="less_than" data-select="textbox">less than</option>
                            <option value="equal" data-select="textbox">equals</option>
                            <option value="more_than_equal" data-select="textbox">more than or equal to</option>
                        ...
                        <select id="date_type" name="date_type" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="date_logic" name="date_logic" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <div id="time_picker" class="inline-grid">
                            <div class="flex">
                                <select name="hours" class=" inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                                ...
                                <select name="minutes" class=" inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                                ...
                                <select name="ampm" class=" inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                                    <option value="am">AM</option>
                                    <option value="pm">PM</option>
                                </select>
                            </div>
                        </div>
                        <select id="minuate_date_picker" name="minuate_date_picker" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="hour_date_picker" name="hour_date_picker" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="week_date_picker" name="week_date_picker" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="month_date_picker" name="month_date_picker" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="boolean_logic" name="boolean_logic" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="true">True</option>
                            <option value="false">False</option>
                        </select>
                        <!-- custom logics (discoutns) -->
                        <select id="discount_applications" name="discount_applications" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="discount_applications_value_type" name="discount_applications_value_type" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="discount_application_type" name="discount_application_type" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="target_type" name="target_type" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="target_selection" name="target_selection" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="allocation_method" name="allocation_method" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="address" name="address" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="duties" name="duties" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="discount_allocations" name="discount_allocations" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="origin_location" name="origin_location" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <!-- custom logics (order) -->
                        <select id="metafield" name="metafield" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md " data-extra="addanother-minus-selected">
                        ...
                        <select id="tax_lines" name="tax_lines" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="source_name" name="source_name" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="processing_method" name="processing_method" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="discount_codes" name="discount_codes" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="discount_code_type" name="discount_code_type" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="client_details" name="client_details" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="text_name_text_value" name="text_name_text_value" class="option-form">
                            <option value="name" data-select="text_logic">Name</option>
                            <option value="value" data-select="text_logic">Value</option>
                        </select>
                        <select id="customer_state" name="customer_state" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="marketing_opt_in_level" name="marketing_opt_in_level" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="single_opt_in">Single opt in</option>
                            <option value="confirmed_opt_in">Confirmed opt in</option>
                            <option value="unknown">Unknown</option>
                        </select>
                        <select id="discount_applications_type" name="discount_applications_type" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="automatic">automatic</option>
                            <option value="discount_code">Discount code</option>
                            <option value="manual">Manual</option>
                            <option value="script">Script</option>
                        </select>
                        <select id="discount_applications_target_selection" name="discount_applications_target_selection" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="all">All</option>
                            <option value="entitled">Entitled</option>
                            <option value="explicit">Explicit</option>
                        </select>
                        <select id="discount_applications_target_type" name="discount_applications_target_type" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="line_item">Line item</option>
                            <option value="shipping_line">Shipping line</option>
                        </select>
                        <select id="financial_status" name="financial_status" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="fulfillment_status" name="fulfillment_status" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="shipping_methods" name="shipping_methods" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="tax_exemptions" name="tax_exemptions" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <!---- select trigger ----->
                        <select id="triggers" name="triggers" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_Cart" name="trigger_Cart" class="option-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="carts/create">created</option>
                            <option value="carts/update">updated</option>
                        </select>
                        <select id="trigger_Checkout" name="trigger_Checkout" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_Collection" name="trigger_Collection" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_CollectionPublication" name="trigger_CollectionPublication" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_Customer" name="trigger_Customer" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_CustomerSavedSearch" name="trigger_CustomerSavedSearch" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="customer_groups/create">create</option>
                            <option value="customer_groups/update">update</option>
                        </select>
                        <select id="trigger_Dispute" name="trigger_Dispute" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="disputes/create">create</option>
                            <option value="disputes/update">update</option>
                        </select>
                        <select id="trigger_Domain" name="trigger_Domain" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_DraftOrder" name="trigger_DraftOrder" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_Fulfillment" name="trigger_Fulfillment" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="fulfillments/create">create</option>
                            <option value="fulfillments/update">update</option>
                        </select>
                        <select id="trigger_FulfillmentEvent" name="trigger_FulfillmentEvent" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="fulfillment_events/create">create</option>
                            <option value="fulfillment_events/delete">delete</option>
                        </select>
                        <select id="trigger_Location" name="trigger_Location" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="locations/create">create</option>
                            <option value="locations/update">update</option>
                        </select>
                        <select id="trigger_Order" name="trigger_Order" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_OrderEdit" name="trigger_OrderEdit" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="orders/edited">edited</option>
                        </select>
                        <select id="trigger_OrderTransaction"  name="trigger_OrderTransaction" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="order_transactions/create">create</option>
                        </select>
                        <select id="trigger_Product" name="trigger_Product" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_ProductListing" name="trigger_ProductListing" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_Profile" name="trigger_Profile" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                        ...
                        <select id="trigger_Refund" name="trigger_Refund" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="refunds/create">create</option>
                        </select>
                        <select id="trigger_Shop" name="trigger_Shop" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="app/uninstalled">uninstalled</option>
                            <option value="shop/update">update</option>
                        </select>
                        <select id="trigger_ShopAlternateLocale" name="trigger_ShopAlternateLocale" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="locales/create">create</option>
                            <option value="locales/update">update</option>
                        </select>
                        <select id="trigger_TenderTransaction" name="trigger_TenderTransaction" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
                            <option value="tender_transactions/create">create</option>
                        </select>
                        <select id="trigger_Theme" name="trigger_Theme" class="trigger-form  inline-grid m-1.5 py-1.5 pr-8 text-sm shadow-sm focus:ring-indigo-500 focus:border-indigo-500 border-gray-300 rounded-md ">
